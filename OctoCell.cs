...
///     1.29289321881345L0.707106781186548 1M1 1.29289321881345L1 1.70710678118655L0.707106781186548 2L0.292893218813452 2M1
///     1.70710678118655L1.29289321881345 2L1 2.29289321881345L0.707106781186548 2M1 2.29289321881345L1
///     2.70710678118655L0.707106781186548 3L0.292893218813452 3M1 2.70710678118655L1.29289321881345 3L1
///     3.29289321881345L0.707106781186548 3M1 3.29289321881345L1 3.70710678118655L0.707106781186548 4L0.292893218813452 4M1
///     3.70710678118655L1.29289321881345 4L1 4.29289321881345L0.707106781186548 4M1 4.29289321881345L1
///     4.70710678118655L0.707106781186548 5L0.292893218813452 5M1 4.70710678118655L1.29289321881345 5L1
///     5.29289321881345L0.707106781186548 5M1 5.29289321881345L1 5.70710678118655L0.707106781186548 6L0.292893218813452 6M1
///     5.70710678118655L1.29289321881345 6L1 6.29289321881345L0.707106781186548 6M1 6.29289321881345L1
...
///     4M7.70710678118655 5L7.29289321881345 5M7.70710678118655 6L7.29289321881345 6M7.70710678118655 7L7.29289321881345 7'
///     fill='none' stroke-width='.05' stroke='black' /&gt;&lt;/svg&gt;</image>
/// <remarks>
///     Constructor.</remarks>
public struct OctoCell(int x, int y, bool isSquare) : IEquatable<OctoCell>, INeighbor<OctoCell>, INeighbor<object>, IHasSvgGeometry
{
    ...
    /// <summary>
    ///     Specifies whether this cell is a square or an octagon. If it is a square, it is south-east of the octagon with the
    ///     same coordinates.</summary>
    ...
    public class Grid : Structure<OctoCell>
    {
        ...
        /// <summary>
        ///     Constructs an <see cref="Grid"/> that forms a rectangle. Along the perimeter all the cells will be octagons.
        ///     Only squares internal to these octagons are included.</summary>
        /// <param name="width">
        ///     The number of octagons in the x direction.</param>
        /// <param name="height">
        ///     The number of octagons in the y direction.</param>
    ...
    public class Vertex : Coordinates.Vertex
    {
        ...
        private const double _d1 = .29289321881345247559915563789515096071516406231155;   // 1 - 1/√2
        private const double _d2 = .70710678118654752440084436210484903928483593768845;   // 1/√2
        private static readonly double[] _xs = [0, 0, _d1, _d2];
        private static readonly double[] _ys = [_d2, _d1, 0, 0];

        /// <inheritdoc/>
        public override PointD Point => new(CellX + _xs[Pos], CellY + _ys[Pos]);
    ...
    public static bool operator ==(OctoCell left, OctoCell right) => left.Equals(right);
