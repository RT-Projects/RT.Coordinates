...
///     Type of cell (for example, <see cref="Square"/> or <see cref="Hex"/>).</typeparam>
/// <typeparam name="TDirection">
///     Type (usually an enum type) that defines the set of possible directions (for example, <see cref="Square.Direction"/>
///     or <see cref="Hex.Direction"/>).</typeparam>
