...
{
    /// <summary>
    ///     Describes a way in which the maze generation algorithm (<see cref="Structure{TCell}.GenerateMaze(System.Func{int,
    ///     int, int}, MazeBias)"/>) proceeds.</summary>
    public enum MazeBias
    {
        ...
        ///     generally leads to more winding paths.</summary>
        Winding
    }
}
