...
/// <summary>
///     <para>
///         Represents a cell in a <see cref="Grid"/>. Each cell may be a square or a triangle, which are all slightly tilted.</para></summary>
/// <image type="raw">
///     &lt;svg viewBox="-.3679 -.1 7 7" xmlns="http://www.w3.org/2000/svg"&gt;&lt;path d="m1.469-.7372-.2679 1 .2679 1-1
///     .2679-.2679 1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321-.2679 1-1-.2679m4.268-1-.2679 1 .2679 1-1
///     .2679-.2679 1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321-.2679 1-1-.2679m4.268-1-.2679 1 .2679 1-1
///     .2679-.2679 1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321-.2679 1-1-.2679m4.268-1-.2679 1 .2679 1-1
///     .2679-.2679 1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321-.2679 1-1-.2679m2.268 1-.2679-1m-5.732
///     1-.2679 1 .2679 1-1 .2679-.2679 1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m3-.2679-.2679 1 .2679
///     1-1 .2679-.2679 1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m3-.2679-.2679 1 .2679 1-1 .2679-.2679
///     1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m3-.2679-.2679 1 .2679 1-1 .2679-.2679
///     1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m-5 1.732-.2679 1 .2679 1-1 .2679-.2679
///     1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m3-.2679-.2679 1 .2679 1-1 .2679-.2679
///     1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m3-.2679-.2679 1 .2679 1-1 .2679-.2679
///     1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m3-.2679-.2679 1 .2679 1-1 .2679-.2679
///     1-1-.2679m1-1.732.2679 1-1-.2679.7321-.7321 1-.2679-.7321-.7321m-5 1.732-.2679 1 .2679 1-1 .2679m-.2679-1 .2679
///     1-1-.2679.7321-.7321 1-.2679-.7321-.7321m3-.2679-.2679 1 .2679 1-1 .2679m-.2679-1 .2679 1-1-.2679.7321-.7321
...
///     1.732-.268-1 .268-1-.268-1 .268-1-.268-1 .268-1-.268-1 .268-1 1 .2679 1-.2679 1 .2679 1-.2679 1 .2679 1-.2679 1 .2679
///     1-.2679" fill="none" stroke="#000000" stroke-width=".05"/&gt;&lt;/svg&gt;</image>
public struct Snubquad(int x, int y, Snubquad.Tile subtile) : IEquatable<Snubquad>, INeighbor<Snubquad>, INeighbor<object>, IHasSvgGeometry
{
    ...
    /// <remarks>
    ///     The reason the arguments are all doubled is because a single integer coordinate pair refers to multiple snubquads
    ///     (arranged in a 3×2). By using doubled values, we effectively support half-integer points and sizes. Note that the
    ///     final number of cells is about <paramref name="dw"/>×<paramref name="dh"/>×3/2.</remarks>
    ...
    /// <summary>
    ///     Returns the vertices along the perimeter of this <see cref="Snubquad"/> assuming that we’re rendering a rectangle
    ///     positioned at (<paramref name="dx"/>/2, <paramref name="dy"/>/2) and of size <paramref name="dw"/>/2 × <paramref
    ///     name="dh"/>/2 and we want the edges of the rectangle straightened.</summary>
    /// <param name="dx">
    ///     Double the x-coordinate of the top-left corner of the rectangle.</param>
    /// <param name="dy">
    ///     Double the y-coordinate of the top-left corner of the rectangle.</param>
    ...
    /// <summary>
    ///     Returns the vertices along the perimeter of this <see cref="Snubquad"/>, going clockwise from the top (square or
    ///     up-pointing tri) or top-left (down-pointing tri).</summary>
    /// <param name="atEdges">
    ///     If specified, renders some of the edges of the <see cref="Snubquad"/> in such a way that they join up to form a
    ///     larger rectangle. For example, if <see cref="AtEdges.Top"/> is specified, this <see cref="Snubquad"/> is assumed
    ...
    public class Vertex(int x, int y, Vertex.VertexPos pos) : Coordinates.Vertex
    {
        ...
        private const double _s = .2679491924311227065;     // = 2 − √3

        /// <inheritdoc/>
        public override PointD Point => Pos switch
        {
            VertexPos.TL => new(2 * CellX, 2 * CellY),
            VertexPos.TM => new(2 * CellX + 1, 2 * CellY + _s),
            VertexPos.ML => new(2 * CellX - _s, 2 * CellY + 1),
            VertexPos.MC => new(2 * CellX + 1 - _s, 2 * CellY + 1 + _s),
    ...
    public static bool operator ==(Snubquad left, Snubquad right) => left.Equals(right);
